...
public class HealthTracker {
	...
	//@ public invariant category != null;
	private /*@ spec_public nullable @*/ Category[] category;	
	
	//@ public invariant nrCategories >= 0 && nrCategories <= category.length;
	private /*@ spec_public @*/ int nrCategories;

	
	/*@ public normal_behavior
	  @ requires nrCategories >= 0 && nrCategories >= category.length - 1; 
	  ...
	  @ public normal_behavior
	  @ requires nrCategories >= 0 && nrCategories < category.length - 1; 
	  @ requires \typeof(category) == \type(Category[]); // to exclude the possibility of an ArrayStoreException
