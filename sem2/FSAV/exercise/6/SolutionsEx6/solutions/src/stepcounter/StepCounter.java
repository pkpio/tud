/*
 * Model fields are declared to specify the interface instead of using 
 * queries.
 */
package stepcounter;
...
public interface StepCounter {
    ...
    //@ public instance model int _stepsTotal;
    //@ public instance model int _stepSize;
    
	//@ public instance invariant _stepsTotal >= 0;
	//@ public instance invariant _stepSize >= 0;
	
	
	/*@ public normal_behavior
	  @ requires true;
	  @ ensures _stepsTotal == 0;
     @ ensures _stepSize == 0;
	  @*/
	public void reset();
	...
	/*@ public normal_behavior
	  @ requires p_inc >= 0;
	  @ ensures _stepsTotal == \old(_stepsTotal) + p_inc;
	  @*/
